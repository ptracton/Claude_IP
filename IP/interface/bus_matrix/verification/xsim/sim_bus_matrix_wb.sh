#!/usr/bin/env bash
# sim_bus_matrix_wb.sh — Vivado xsim directed test for bus_matrix_wb.
#
# Usage:
#   cd IP/interface/bus_matrix
#   source setup.sh
#   bash verification/xsim/sim_bus_matrix_wb.sh
...
WORK_DIR="${BM_ROOT}/verification/work/xsim/wb"
TOP="tb_bus_matrix_wb"
