#!/usr/bin/env bash
# sim_bus_matrix_axi.sh — Vivado xsim directed test for bus_matrix_axi.
#
# Usage:
#   cd IP/interface/bus_matrix
#   source setup.sh
#   bash verification/xsim/sim_bus_matrix_axi.sh
...
WORK_DIR="${BM_ROOT}/verification/work/xsim/axi"
TOP="tb_bus_matrix_axi"
