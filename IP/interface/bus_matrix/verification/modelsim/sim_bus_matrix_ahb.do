# sim_bus_matrix_ahb.do — ModelSim compile and simulate for AHB bus_matrix testbench.
# Usage: vsim -do sim_bus_matrix_ahb.do
# Waveforms: source sim_bus_matrix_ahb_wave.do  (inside ModelSim after sim starts)
...
vlog -sv -work work \
    ...
    +incdir+$COMMON_TESTS \
    +incdir+$COMMON_TASKS \
    $TB_DIR/tb_bus_matrix_ahb.sv

# Simulate
vsim -t 1ns -lib work work.tb_bus_matrix_ahb \
    -voptargs="+acc"
