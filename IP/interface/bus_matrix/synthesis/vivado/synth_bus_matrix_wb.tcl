# synth_bus_matrix_wb.tcl — Vivado OOC synthesis for bus_matrix_wb.
#
...
#   source setup.sh
#   vivado -mode batch -source synthesis/vivado/synth_bus_matrix_wb.tcl
...
read_verilog -sv $DESIGN_DIR/bus_matrix_wb.sv
