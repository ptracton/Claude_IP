-- timer_apb_if.vhd — APB4 bus interface for Timer IP (VHDL-2008).
--
-- Translates APB4 transactions into the flat register-file access bus.
-- Port-for-port equivalent to timer_apb_if.sv.
--
-- Protocol notes:
...
end entity timer_apb_if;

architecture rtl of timer_apb_if is
begin
