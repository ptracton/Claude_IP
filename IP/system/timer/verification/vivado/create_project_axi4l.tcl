# create_project_axi4l.tcl — Vivado project for timer AXI4-Lite simulation
#
# Usage:
#   vivado -mode tcl -source create_project_axi4l.tcl
#   or: source create_project_axi4l.tcl  (from the Vivado Tcl console)
#
...
set work_dir  "${timer_dir}/verification/vivado/work/axi4l"
set wave_tcl  "${script_dir}/wave_axi4l.tcl"

# ---------------------------------------------------------------------------
# Create project
# ---------------------------------------------------------------------------
create_project tb_timer_axi4l "${work_dir}" -part xc7z010clg400-1 -force
...
add_files -norecurse [list \
    ...
    "${common_dir}/design/rtl/verilog/claude_axi4l_if.sv" \
    "${rtl_dir}/timer_axi4l.sv"                          \
]
...
# ---------------------------------------------------------------------------
add_files -norecurse -sim_only "${tb_dir}/tb_timer_axi4l.sv"
set_property file_type SystemVerilog [get_files tb_timer_axi4l.sv]

# ---------------------------------------------------------------------------
# Simulation fileset configuration
# ---------------------------------------------------------------------------
set_property top              tb_timer_axi4l     [get_filesets sim_1]
...
puts ""
puts "Project created: ${work_dir}/tb_timer_axi4l.xpr"
puts "To simulate:     File > Open Project > work/axi4l/tb_timer_axi4l.xpr"
