# tb_timer_ahb.do — ModelSim GUI script for AHB-Lite timer testbench
#
# Usage (from ModelSim Transcript or File > Run Script):
#   do /path/to/verification/modelsim/tb_timer_ahb.do
#
...
set WORK   ${TIMER}/verification/work/modelsim/ahb_sv
...
# Start simulation
# ---------------------------------------------------------------------------
vsim -voptargs=+acc work.tb_timer_ahb

# ---------------------------------------------------------------------------
# Load waveform configuration and run
# ---------------------------------------------------------------------------
do [file join [file dirname [info script]] tb_timer_ahb_wave.do]
