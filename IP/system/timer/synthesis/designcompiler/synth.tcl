...
set_app_var search_path [list \
    "./../../design/rtl/verilog" \
    "./../../../../common/design/rtl/verilog" \
    "./../../design/rtl/vhdl" \
    "./../../../../common/design/rtl/vhdl" \
]

suppress_message "WARNI*"
suppress_message "INFOI*"

# Reports and netlists land in PDK-tagged subdirectories so both runs coexist
...
analyze -format sverilog {claude_apb_if.sv claude_ahb_if.sv claude_axi4l_if.sv claude_wb_if.sv}
analyze -format sverilog {timer_reg_pkg.sv timer_regfile.sv timer_core.sv}

analyze -format vhdl {claude_apb_if.vhd claude_ahb_if.vhd claude_axi4l_if.vhd claude_wb_if.vhd}
analyze -format vhdl {timer_reg_pkg.vhd timer_regfile.vhd timer_core.vhd}
...
# =========================================================================
# VHDL variants (clock port is protocol-specific)
# =========================================================================

array set vhdl_clocks {
    timer_apb   PCLK
    timer_ahb   HCLK
    timer_axi4l ACLK
    timer_wb    CLK_I
